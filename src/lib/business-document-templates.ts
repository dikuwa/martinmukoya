...
type DocumentFormValues = {
  ...
  recipientPhone?: string; recipientWhatsApp?: string; senderName?: string; senderRole?: string;
  issueDate?: string | null; expiryDate?: string | null; reviewDate?: string | null;
};

type DocumentLead = { name?: string | null; email?: string | null; company?: string | null; phone?: string | null; whatsAppNumber?: string | null };
type DocumentProject = { title?: string | null; name?: string | null; description?: string | null; summary?: string | null };
...
export function buildDocumentTemplateContext(input: {
  ...
  return {
    ...
    client_name: clientName, recipient_name: clientName, recipient_email: clientEmail, client_email: clientEmail,
    ...
    client: { name: clientName, email: clientEmail, company: clientCompany, phone: clientPhone, whatsapp_number: clientWhatsApp },
    recipient: { name: clientName, email: clientEmail, company: clientCompany, phone: clientPhone, whatsapp_number: clientWhatsApp },
