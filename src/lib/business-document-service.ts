...
export async function createBusinessDocument(input: BusinessDocInput) {
  const issuer = await getIssuerSnapshot(input.siteId ?? null);
...
export async function seedTemplates(userId?: string) {
  ...
  const templates = [
    ...
    // Job application / cover letter template (Martin Mukoya personal identity)
    { name: "Job application / cover letter", documentCategory: "BUSINESS_LETTER" as const, defaultBodyMarkdown: "# [Subject]\n\n**Date:** \n\n**To:**\n[Hiring Manager Name]\n[Company Name]\n[Company Address]\n\n**From:**\nMartin Mukoya\n[martinmukoya@gmail.com]\n+264 81 494 2473\n\nDear [Hiring Manager Name],\n\nI am writing to express my interest in the [Position Title] role at [Company Name], as advertised on [Job Board/Company Website]. With my background in building practical business systems — websites, booking platforms, e-commerce flows, and AI automations — I am confident I can contribute meaningfully to your team.\n\n## Why [Company Name]\n\n[Explain why you're interested in this specific company and role]\n\n## Relevant Experience\n\n- **Full-stack development**: Building production-ready web applications with Next.js, React, TypeScript, and PostgreSQL\n- **Business systems**: Designing lead capture, booking systems, e-commerce flows, and AI automation that solve real operational problems\n- **End-to-end delivery**: From requirements gathering through deployment, monitoring, and iteration\n- **Communication**: Translating technical decisions into business language for stakeholders\n\n## What I Bring\n\nI don't just write code — I build systems that help businesses get more bookings, reduce manual work, capture leads, and turn visitors into clients. My approach is practical, outcome-focused, and grounded in understanding the actual business problem before proposing a technical solution.\n\nI would welcome the opportunity to discuss how my experience aligns with your needs. Thank you for your time and consideration.\n\nSincerely,\n\nMartin Mukoya\n---\n\n**Martin Mukoya**", signatureRequired: false },
  ];
