...
export default async function DocumentsPage({ searchParams }: Props) {
  ...
  const documentWhere = {
    ...
    ...(params.status && params.status !== "all" ? { status: params.status as "DRAFT" | "ISSUED" | "ACCEPTED" | "PARTIALLY_PAID" | "PAID" | "SUPERSEDED" | "VOID" } : {}),
