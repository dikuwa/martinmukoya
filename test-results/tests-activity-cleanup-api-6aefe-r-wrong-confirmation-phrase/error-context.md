...
- Name: tests/activity-cleanup-api.spec.ts >> Activity Cleanup API >> POST /api/admin/cleanup/execute >> returns 400 for wrong confirmation phrase
- Location: tests/activity-cleanup-api.spec.ts:96:9
