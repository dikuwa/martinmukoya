...
- Name: tests/activity-cleanup-api.spec.ts >> Activity Cleanup API >> POST /api/admin/cleanup/execute >> returns 401 when not authenticated
- Location: tests/activity-cleanup-api.spec.ts:82:9
